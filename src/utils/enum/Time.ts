...
export function getHoursAndMinutesFromDateString(dateTimeString) {
...
export const format = function (secondsSinceEpoch, format = "MM/DD/YYYY h:mma", timezone = "America/Denver") {
